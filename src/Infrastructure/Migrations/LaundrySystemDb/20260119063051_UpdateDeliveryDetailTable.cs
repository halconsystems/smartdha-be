...
{
    /// <inheritdoc />
    public partial class UpdateDeliveryDetailTable : Migration
    {
        /// <inheritdoc />
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SvPoint", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SvPointId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    Created = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SvVehicle", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SvVehicle_ApplicationUser_DriverId",
                        column: x => x.DriverId,
                        principalTable: "ApplicationUser",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_SvVehicle_SvPoint_SvPointId",
                        column: x => x.SvPointId,
                        principalTable: "SvPoint",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShopVehicles_SvPointId",
                table: "ShopVehicles",
                column: "SvPointId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_OrderDispatches_SvVehicle_SvVehicleId",
                table: "OrderDispatches",
                column: "SvVehicleId",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_ShopVehicles_SvPoint_SvPointId",
                table: "ShopVehicles",
                column: "SvPointId",
                principalTable: "SvPoint",
                principalColumn: "Id");
