...
{
    /// <inheritdoc />
    public partial class Newtablefacilityimages : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FacilitiesImages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FacilitiesImages_Facilities_FacilityId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FacilitiesImages_FacilityId",
                table: "FacilitiesImages",
                column: "FacilityId");
