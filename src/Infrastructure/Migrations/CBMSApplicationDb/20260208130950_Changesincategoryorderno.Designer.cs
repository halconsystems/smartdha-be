...
namespace DHAFacilitationAPIs.Infrastructure.Migrations.CBMSApplicationDb
{
    ...
    [Migration("20260208130950_Changesincategoryorderno")]
    partial class Changesincategoryorderno
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DHAFacilitationAPIs.Domain.Entities.CBMS.BookingDiscount", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("DHAFacilitationAPIs.Domain.Entities.CBMS.BookingTax", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("DHAFacilitationAPIs.Domain.Entities.CBMS.ClubServiceCategory", b =>
                {
                    ...
                    b.ToTable("ClubServiceCategories");
                });
            ...
            modelBuilder.Entity("DHAFacilitationAPIs.Domain.Entities.CBMS.Facility", b =>
                {
                    ...
                    b.HasIndex("ClubCategoryId", "Code")
                        .IsUnique();
            ...
            modelBuilder.Entity("DHAFacilitationAPIs.Domain.Entities.CBMS.FacilityUnit", b =>
                {
                    b.HasOne("DHAFacilitationAPIs.Domain.Entities.CBMS.DHAClub", "Club")
                        .WithMany()
                        .HasForeignKey("ClubId")
            ...
            modelBuilder.Entity("DHAFacilitationAPIs.Domain.Entities.CBMS.FacilityUnit", b =>
                {
                    b.Navigation("FacilityUnitImages");

                    b.Navigation("FacilityUnitServices");
                });
