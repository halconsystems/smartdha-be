...
namespace DHAFacilitationAPIs.Infrastructure.Data.SQLite
{
    ...
    [Migration("20260209084806_Changesinfumigation")]
    partial class Changesinfumigation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DHAFacilitationAPIs.Domain.Entities.FMS.ShopDTSetting", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.Property<Guid>("FemDTSettingId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("FemDTSettingId");

                    b.HasIndex("ShopId");

                    b.ToTable("ShopDTSettings");
                });
            ...
            modelBuilder.Entity("DHAFacilitationAPIs.Domain.Entities.MemberChildren", b =>
                {
                    ...
                    b.Property<Guid>("MemberSpouseId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DHAFacilitationAPIs.Domain.Entities.MemberRequest", b =>
                {
                    ...
                    b.Property<int?>("CauseRetirement")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("NonPassportCopy")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
            ...
            modelBuilder.Entity("DHAFacilitationAPIs.Domain.Entities.PMS.ProcessStepAudit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("DHAFacilitationAPIs.Domain.Entities.FMS.ShopDTSetting", b =>
                {
                    b.HasOne("DHAFacilitationAPIs.Domain.Entities.FMS.FemDTSetting", "FemDTSetting")
                        .WithMany()
                        .HasForeignKey("FemDTSettingId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("DHAFacilitationAPIs.Domain.Entities.FMS.FemgutionShops", "Shop")
                        .WithMany()
                        .HasForeignKey("ShopId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("FemDTSetting");
            ...
            modelBuilder.Entity("DHAFacilitationAPIs.Domain.Entities.MemberChildren", b =>
                {
                    ...
                    b.HasOne("DHAFacilitationAPIs.Domain.Entities.MemberSpouse", "MemberSpouse")
                        .WithMany("Children")
                        .HasForeignKey("MemberSpouseId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("MemberRequest");

                    b.Navigation("MemberSpouse");
                });
