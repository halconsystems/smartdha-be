...
public class MemberShipController : BaseApiController
{
    ...
    #region MemberShip Category Crud Here
    [HttpPost("Create-MemberShipCategories"), AllowAnonymous]
    [Tags("02 - MemberShip-Category")]
    ...
    #region Member Religon Crud Here
    ...
    [Tags("03 - Religon")]
    public async Task<ActionResult<ReligonDTO>> GetAllReligon(CancellationToken ct)
    {
    ...
    #region Religon Section Crud Here
    [HttpPost("Create-ReligonSect"), AllowAnonymous]
    [Tags("04 - Religon-Section")]
    ...
    [Tags("04 - Religon-Section")]
    public async Task<ActionResult<ReligonSectDTO>> GetAllReligonSect(CancellationToken ct)
    {
    ...
    [Tags("04 - Religon-Section")]
    public async Task<ActionResult<ReligonSectDTO>> GetAllReligonSectById(Guid ReligonId, CancellationToken ct)
    {
    ...
    #region Member Reguest Process
    [HttpGet("get-MemberShipRequestLisr"), AllowAnonymous]
    [Tags("05 - MemberShip-Request")]
    ...
    #region MemberShip Request From Web Here
    [HttpPost("MemberShip-Request")]
    [Tags("06 - MemberShip-Request-Web")]
