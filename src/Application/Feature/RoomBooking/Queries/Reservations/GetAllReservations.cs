...
public record GetAllReservationsQuery(Guid UserId) : IRequest<List<ReservationCardDto>>;

public class GetAllReservationsQueryHandler : IRequestHandler<GetAllReservationsQuery, List<ReservationCardDto>>
{
    ...
    public async Task<List<ReservationCardDto>> Handle(GetAllReservationsQuery request, CancellationToken ct)
    {
