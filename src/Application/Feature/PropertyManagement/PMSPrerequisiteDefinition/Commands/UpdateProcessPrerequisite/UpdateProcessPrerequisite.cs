...
namespace DHAFacilitationAPIs.Application.Feature.PropertyManagement.PMSPrerequisiteDefinition.Commands.UpdateProcessPrerequisite;
public record UpdateProcessPrerequisiteCommand
(
    Guid ProcessId,
...
public class UpdateProcessPrerequisiteHandler
    : IRequestHandler<UpdateProcessPrerequisiteCommand, ApiResult<bool>>
{
    private readonly IPMSApplicationDbContext _db;

    public UpdateProcessPrerequisiteHandler(IPMSApplicationDbContext db)
    {
        _db = db;
    }

    public async Task<ApiResult<bool>> Handle(
        UpdateProcessPrerequisiteCommand r,
