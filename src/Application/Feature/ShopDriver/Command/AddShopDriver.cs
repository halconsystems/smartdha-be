...
public record RegisterShopDriverCommand(
    string Email,
    string Name,
    string MobileNo,
    string Password,
    ...
    : IRequestHandler<RegisterShopDriverCommand, SuccessResponse<Guid>>
{
    ...
    public RegisterShopDriverCommandHandler(
    ...
    public async Task<SuccessResponse<Guid>> Handle(RegisterShopDriverCommand request, CancellationToken ct)
    {
        ...
        try
        {
            ...
            const string driverRoleName = "ShopDriver";
