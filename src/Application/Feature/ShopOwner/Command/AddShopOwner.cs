...
namespace DHAFacilitationAPIs.Application.Feature.ShopOwner.Command;


public record RegisterShopOwnerCommand(
    string Email,
    string Name,
    string MobileNo,
    string Password,
...
public class RegisterShopOwnerCommandHandler
    : IRequestHandler<RegisterShopOwnerCommand, SuccessResponse<Guid>>
{
    private readonly IApplicationDbContext _context;
    private readonly UserManager<ApplicationUser> _userManager;
    private readonly RoleManager<IdentityRole> _roleManager;

    public RegisterShopOwnerCommandHandler(
    ...
    public async Task<SuccessResponse<Guid>> Handle(RegisterShopOwnerCommand request, CancellationToken ct)
    {
        ...
        try
        {
            ...
            const string driverRoleName = "ShopOwner";
        ...
        catch (Exception ex)
        {
            ...
            throw new ApplicationException($"Register Owner failed: {ex.Message}", ex);
        }
    }
}
