...
public record UpdateClubFeeDefinitionWithOptionsCommand(
...
public class UpdateFeeDefinitionWithOptionsHandler
    : IRequestHandler<UpdateClubFeeDefinitionWithOptionsCommand, ApiResult<bool>>
{
    private readonly IOLMRSApplicationDbContext _db;

    public UpdateFeeDefinitionWithOptionsHandler(IOLMRSApplicationDbContext db)
    {
        _db = db;
    }

    public async Task<ApiResult<bool>> Handle(
        UpdateClubFeeDefinitionWithOptionsCommand r,
