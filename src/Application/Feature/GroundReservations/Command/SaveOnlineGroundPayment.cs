...
public record SaveGroundPaymentIpnCommand(
    PaymentIpnRequestDto Payload,
    string RawPayload
) : IRequest<Guid>;
public class SaveGroundPaymentIpnCommandHandler
    : IRequestHandler<SaveGroundPaymentIpnCommand, Guid>
{
    private readonly IOLMRSApplicationDbContext _ctx;

    public SaveGroundPaymentIpnCommandHandler(IOLMRSApplicationDbContext ctx)
    {
        _ctx = ctx;
    }

    public async Task<Guid> Handle(SaveGroundPaymentIpnCommand request, CancellationToken ct)
    {
        ...
        var entity = new GroundPaymentIpnLogs
        {
            Id = Guid.NewGuid(),
        ...
        _ctx.GroundPaymentIpnLogs.Add(entity);
